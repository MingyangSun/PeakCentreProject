...
<head>
<meta charset="utf-8">
<title>PeakCentre - View Workout Summary</title>
...
<body>
				...
				<div class="box-content">
					<div class="form-row">
						<p>Please specify the User Name and Start Date associated with
							the training plan you would like to view.</p>
					</div>
					<br> <br>
					<div class="form-row">
	...
	<script>
		function showTable() {
			...
			for (i = 0; i < weeks; i++) {
				...
				table += '<tr>' + '<th>'
						...
						+ new Date(startdate.setDate(startdate.getDate() + 1))
								.format("MM/dd") + '</th>' + '</tr>'
						+ '</thead>';
				table += '<tbody>' + '<tr>' + '<td>B Z1 35s</td>'
						+ '<td>SW 30s</td>' + '<td>ST1</td>'
						+ '<td>R Z3 15s</td>' + '<td>R Z1 50s</td>'
						+ '<td>ST2</td>' + '<td>B Z3 15s</td>' + '<td>90%</td>'
						+ '</tr>';
				table += '</tbody>';
				table += '</table>';
				table += '</div>' + '</div>';
			...
			table += '<table class="display">';
			table += '<thead>' + '<tr>' + '<th>Exercise</th>'
					+ '<th colspan="6">W1</th>' + '<th colspan="6">W2</th>'
					+ '<th colspan="6">W3</th>' + '<th colspan="6">W4</th>'
					+ '</tr>' + '</thead>';
			table += '<tbody>' + '<tr>'
					+ '<td rowspan="2">Close Stance Back Squats</td>'
					+ '<td>W</td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td>W</td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td>W</td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td>W</td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>';
			table += '<tr>' + '<td>R</td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td>R</td>'
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '<td>R</td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td>R</td>'
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '</tr>';
			table += '<tr>' + '<td rowspan="2">Standing DB Overhead Press</td>'
					+ '<td>W</td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td>W</td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td>W</td>' + '<td></td>' + '<td></td>' + '<td></td>'
			...
			table += '<tr>' + '<td>R</td>' + '<td></td>' + '<td></td>'
					...
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '</tr>';
			table += '<tr>' + '<td rowspan="2">Romanian Deadlift</td>'
					+ '<td>W</td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td>W</td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td>W</td>' + '<td></td>' + '<td></td>' + '<td></td>'
			...
			table += '<thead>' + '<tr>' + '<th>Exercise</th>'
					...
					+ '<th colspan="6">W3</th>' + '<th colspan="6">W4</th>'
					+ '</tr>' + '</thead>';
			table += '<tbody>' + '<tr>' + '<td rowspan="2">Deadlift</td>'
					+ '<td>W</td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td>W</td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td>W</td>' + '<td></td>' + '<td></td>' + '<td></td>'
			...
			table += '<tr>' + '<td>R</td>' + '<td></td>' + '<td></td>'
					...
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '</tr>';
			table += '<tr>' + '<td rowspan="2">DB Chest Press</td>'
					+ '<td>W</td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td>W</td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td>W</td>' + '<td></td>' + '<td></td>' + '<td></td>'
			...
			table += '<tr>' + '<td>R</td>' + '<td></td>' + '<td></td>'
					...
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '</tr>';
			table += '<tr>' + '<td rowspan="2">DB Walking Lunge</td>'
					+ '<td>W</td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td>W</td>' + '<td></td>'
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td>W</td>' + '<td></td>' + '<td></td>' + '<td></td>'
			...
			table += '<tr>' + '<td>R</td>' + '<td></td>' + '<td></td>'
					...
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '</tr>';
			table += '<tr>' + '<td rowspan="2">Pull Ups</td>' + '<td>W</td>'
					+ '<td></td>' + '<td></td>' + '<td></td>' + '<td></td>'
					+ '<td></td>' + '<td>W</td>' + '<td></td>' + '<td></td>'
